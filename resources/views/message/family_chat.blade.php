...
@section('content')
    ...
    <div class="card shadow-sm" id="chatCard" style="height: 600px;">
        ...
        <div class="card-body d-flex flex-column p-2">
            ...
            <!-- typing indicator -->
            <div id="typingIndicator" class="small text-muted mb-2" style="height:18px; display:none;">Someone is typing...
            </div>
    ...
    <script type="module">
        ...
        onValue(typingRef, (snap) => {
            ...
            if (others.length > 0) {
                ...
                typingIndicator.textContent = names.join(', ') + (others.length > names.length ? ' and more...' :
                    '') + ' is typing...';
            } else {
