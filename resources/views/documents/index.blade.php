                        ...
                        <div class="row align-items-center" bis_skin_checked="1">
                            ...
                            <div class="col-md-7 text-md-end" bis_skin_checked="1">
                                <div class="addBtns" bis_skin_checked="1">
                                    ...
                                    <!--    Information</a>-->
                                    <a href="{{ route('document.requests.create') }}" class="btn btn-secondary"><i class="fab fa-plus"></i>Add
                                        Request</a> 
                                </div>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('document.requests.show', $req->id) }}"
                                                        class="docBtn"><i class="fa-light fa-eye"></i></a>
                                                    @if ($req->status === 'submitted' && $req->document)
                                                        <a href="{{ route('document.requests.download', $req->id) }}"
                                                            class="docBtn"><i class="fa-light fa-download"></i></a>
                                                    @endif
                                    ...
                                    @forelse ($requests as $req)
                                        @if ($req->type == 2)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($req->status === 'pending')
                                                        <span class="countdown" data-deadline="{{ $req->expires_at->toIsoString() }}"></span>
                                                    @else
                                                        {{ $req->expires_at->format('d M Y H:i') }}
                                                    @endif
                                                </td>
                ...
                <div class="container mt-4">
                    <div class="card shadow-sm">
                        <div class="secondary-card-header">
                            <div class="row">
                                <div class="col-12">
                                    <h5>Emegency Document Requests</h5>
                                </div> 
                            </div>
                        </div>
                        <div class="card-body">
