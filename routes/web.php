...
Route::middleware(FamilyMemberMiddleware::class)->group(function () {
    ...
    Route::get('familyMember/subscriptions', [SubscriptionController::class, 'index'])->name('familyMember.subscriptions.index');
    Route::get('/familyMember/index', [ReportController::class, 'index'])->name('familyMember.report.index');
    Route::get('/familyMember/download_report', [ReportController::class, 'monthly_report'])->name('familyMember.download_report');
...
Route::middleware([FamilyOwnerMiddleware::class])->group(function () {
    ...
    // Route::get('/familyOwner/action-logs', [DailyUpdateController::class, 'index'])->name('familyOwner.logs');
    ...
    Route::get('familyOwner/voice-journal', [VoiceJournalController::class, 'index'])->name('familyOwner.voice-journal.index');
    
    Route::get('familyOwner/meetings', [MeetingController::class, 'index'])->name('familyOwner.meetings.index');
    Route::get('familyOwner/meetings/create', [MeetingController::class, 'create'])->name('familyOwner.meetings.create');
    Route::post('familyOwner/meetings/store', [MeetingController::class, 'store'])->name('familyOwner.meetings.store');
    Route::get('familyOwner/meetings/{meeting}', [MeetingController::class, 'show'])->name('familyOwner.meetings.show');
    Route::get('familyOwner/meetings/{meeting}/edit', [MeetingController::class, 'edit'])->name('familyOwner.meetings.edit');
    Route::put('familyOwner/meetings/{meeting}', [MeetingController::class, 'update'])->name('familyOwner.meetings.update');
    Route::delete('familyOwner/meetings/{meeting}', [MeetingController::class, 'destroy'])->name('familyOwner.meetings.destroy');
